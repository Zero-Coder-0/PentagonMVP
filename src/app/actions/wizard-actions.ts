...
export async function createLiveProjectDirectly(
    ...
    return prisma.project.create({
        data: {
            ...
            lat: parseNumber(flatFormData.lat),
            lng: parseNumber(flatFormData.lng),
            slug: flatFormData.slug,
            total_land_area: flatFormData.total_land_area,
            total_units: parseNumber(flatFormData.total_units),
            total_phases: parseNumber(flatFormData.total_phases),
            ...
            possession_year: parseNumber(flatFormData.possession_year),
            pricedisplay: flatFormData.pricedisplay,
            pricemin: parseNumber(flatFormData.pricemin),
            pricemax: parseNumber(flatFormData.pricemax),
            ...
            ...(flatFormData.developer_name ? {
                developer: {
                    create: {
                        ...
                        years_in_market: parseNumber(flatFormData.developer_years_in_market),
            ...
            specs: {
                create: {
                    no_of_towers: parseNumber(flatFormData.no_of_towers),
                    floors_per_tower: parseNumber(flatFormData.floors_per_tower),
                    units_per_floor: parseNumber(flatFormData.units_per_floor),
                    elevators_per_tower: parseNumber(flatFormData.elevators_per_tower),
                    service_elevators_per_tower: parseNumber(flatFormData.service_elevators_per_tower),
                ...
                projectunits: {
                    create: flatFormData.units.map(u => {
                        ...
                        return {
                            ...
                            type: u.type || null,
                            floornumber: parseNumber(u.floornumber),
                            actualsba: parseNumber(u.actualsba),
                            carpetarea: parseNumber(u.carpetarea),
                            udsarea: parseNumber(u.udsarea),
