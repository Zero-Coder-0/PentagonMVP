// src/app/(dashboard)/dashboard/MapContainer.tsx
'use client';
...
export default function MapContainer() {
  ...
  const handleLocationUpdate = (lat: number, lng: number, name: string) => {
    ...
    // Use nested array format to match type definition in page.tsx
    setMapBounds([
      [lat - 0.03, lng - 0.03], 
      [lat + 0.03, lng + 0.03]
    ]);
  ...
  return (
    <div className="w-full h-full rounded-2xl overflow-hidden border border-slate-300 shadow-lg relative z-0">
      <LeafletMap 
