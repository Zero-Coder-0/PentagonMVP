...
export async function createSingleProject(data: any) {
  try {
    ...
    const { data: project, error: projectError } = await supabase
      ...
      .insert({
        ...
        developer_id: data.developer_id || data.developer,
        rera_registration_no: data.rera_registration_no || data.rera_id,
        project_status: data.project_status || data.status,
        bangalore_zone: data.bangalore_zone || data.zone,
        region: data.region,
        ...
        open_space_percent: data.open_space_percent ? Number(data.open_space_percent) : null,
        ...
        // specifications: data.specifications, // Check if this column exists
