...
import { ProjectV7 } from '../types-v7'

export type ExtendedProjectV7 = ProjectV7 & {
  distance?: number;
  location_area?: string;
};

interface ProjectListProps {
  properties: ExtendedProjectV7[];
    ...
    <div className="flex flex-col gap-2 p-2 overflow-y-auto h-full">
      {properties.map((prop) => (
        ...
        >
          ...
          <p className="text-sm text-gray-500 mt-1">{prop.location_area}</p>
