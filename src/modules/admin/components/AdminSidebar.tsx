    ...
    <aside className="fixed left-0 top-0 h-full w-64 bg-slate-900 text-white shadow-xl z-50 flex flex-col">
      ...
      <nav className="flex-1 p-4 space-y-2">
        ...
        <Link
          ...
          className="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg bg-indigo-600 text-white shadow-md hover:bg-indigo-700 transition-colors"
        >
        ...
        <Link
          href="/dashboard"
          className="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg text-slate-300 hover:bg-slate-800 hover:text-white transition-colors mt-8"
        >
      ...
      <div className="p-4 border-t border-slate-800">
        <button className="flex w-full items-center gap-3 px-4 py-2 text-sm font-medium text-slate-300 hover:text-red-300 transition-colors">
